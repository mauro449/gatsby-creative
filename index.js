            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                <p className="text-white-50 mb-4">Start Bootstrap has everything you need to get your new website up
                  ...
                  strings
                  attached!</p>import React from "react"
import { graphql } from "gatsby"
import Img from "gatsby-image"
          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 mr-auto text-center">
                ...
                <a className="d-block" href="mailto:contact@graphicvine.com">contact@graphicvine.com</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="page-section" id="contact">
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 mr-auto text-center">
                <i className="fas fa-envelope fa-3x mb-3 text-muted"></i>
                <a className="d-block" href="mailto:contact@yourwebsite.com">contact@graphicvine.com</a>
              </div>
            </div>
          </div>
        </section>
